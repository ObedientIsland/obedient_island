...
class Admin::EventsControllerTest < ActionController::TestCase
  ...
  test "should create admin_event" do
    assert_difference('Admin::Event.count') do
      post :create, admin_event: { active: @admin_event.active, name: @admin_event.name, possibility: @admin_event.possibility }
    end
  ...
  test "should update admin_event" do
    patch :update, id: @admin_event, admin_event: { active: @admin_event.active, name: @admin_event.name, possibility: @admin_event.possibility }
    assert_redirected_to admin_event_path(assigns(:admin_event))
  end
